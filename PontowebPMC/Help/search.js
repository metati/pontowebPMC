 ...
 * @author 1
 */
	var strFoundNothing = "Nada encontrado";
	var strSearchStringIsEmpty = "Por favor insira um texto para procurar!";
	...
	function output()
	{
		...
		if (outel)
		{
			...
			{
					for (var i = 0; i < SearchResults.length; i++) 
						outbuffer += "<img src=\"Imagens/bullet_topic.gif\" /><a href = \"javascript:OpnNxtPage('" + SearchResults[i][1] + "');\" class=\"menu\">"+ replaceExtChars(SearchResults[i][0], true) + "</a><br/>";
			}
			else 
			{
