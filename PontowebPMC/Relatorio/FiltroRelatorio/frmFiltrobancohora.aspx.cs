...
public partial class Relatorio_FiltroRelatorio_frmFiltrobancohora : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            PreencheddlSetor();
            PreencheddlMes();
            coIDSetorBancoo.Add("IDSetor", "");
        }

        if(cbSetorFolha.Text != "")
            coIDSetorBancoo["IDSetor"] = cr.CriptograFa(cbSetorFolha.Value.ToString());
    }
