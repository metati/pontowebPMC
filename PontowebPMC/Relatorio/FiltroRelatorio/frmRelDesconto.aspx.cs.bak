...
public partial class Relatorio_FiltroRelatorio_frmRelDesconto : System.Web.UI.Page
{
    ...
    protected void PreencheddlUsuario(string IDSetor)
    {
        ...
        cbServidorDesconto.DataSource = ds;
        cbServidorDesconto.DataBind();
    }
    ...
    protected void PreencheddlSetor()
    {
        ...
        cbSetorDesconto.DataSource = ds;
        cbSetorDesconto.DataBind();
    }
