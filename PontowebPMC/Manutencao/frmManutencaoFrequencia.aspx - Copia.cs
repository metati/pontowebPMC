...
public partial class Manutencao_frmManutencaoFrequencia : System.Web.UI.Page
{
    ...
    protected void PreenchegridFrequencia(int IDSetor, int IDUsuario, int IDMesRef)
    {
        ...
        Freq.DadosUsuario(dsu, IDUsuario, Convert.ToInt32(Session["IDEmpresa"]), IDSetor);
        ...
        {
            Freq.HorasDiasPlantonista(IDMesRef, IDUsuario, Ano, ds, Convert.ToInt32(Session["IDEmpresa"]), IDSetor, cbOcorrencia.Checked);
        }
    ...
    protected void gridFrequencia_HtmlRowPrepared(object sender, DevExpress.Web.ASPxGridView.ASPxGridViewTableRowEventArgs e)
    {
        if (Lei == 1)
        {
            ...
            else if (((Justificado == "0" || Justificado == "10" || Justificado == "") && SituacaoJustificativa != "-1") && DTFrequencia.Date < DateTime.Now.Date && (IDRegimeHOra != "4"))
            {
                e.Row.BackColor = System.Drawing.Color.IndianRed;
                e.Row.ForeColor = System.Drawing.Color.White;
                if (e.Row.Cells.Count == 10)
